import"./main-CvY94YZ6.js";var e=[{id:`all`,label:`Todas as Partes & Técnicas`,iconSvg:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>`},{id:`structure`,label:`Partes que Compõem o Site`,iconSvg:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>`},{id:`techniques`,label:`Técnicas Modernas de UI/Layout`,iconSvg:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>`}],t=[{id:`timeline`,name:`Timeline (Linha do Tempo)`,ptName:`Sequência Cronológica com Nós e Conectores`,category:`techniques`,categoryLabel:`Técnica de UI/Layout`,concept:`Estrutura visual contínua que organiza eventos, marcos históricos ou etapas em ordem cronológica através de nós e uma linha guia.`,purpose:`Roadmaps de produtos, histórico de pedidos/rastreamento de encomendas, evolução de carreira ou registros de auditoria.`,goodPractice:`Utilize nós com cores semânticas distintas para indicar eventos passados (concluídos), atual (em progresso) e futuros.`,commonPitfall:`Colocar textos longos e densos demais dentro de cada nó da timeline sem opção de expandir.`,mnemonic:`Pense nos "Postes de Iluminação ao longo da avenida": a fiação conecta cada ponto em uma sequência lógica.`,htmlSnippet:`<div class="ui-timeline">
...
.ui-timeline-node {
  ...
  background: var(--brand-primary);
      ...
      `}},{id:`hero-section`,name:`Hero Section (Área de Destaque Principal)`,ptName:`Primeira Dobra / Vitrine de Entrada`,category:`structure`,categoryLabel:`Parte que Compõe o Site`,concept:`A primeira seção visual que o usuário vê ao carregar o site ("above the fold"), contendo a proposta de valor central.`,purpose:`Causar forte impacto visual imediato, reter o visitante nos primeiros 5 segundos e incentivar o primeiro clique.`,goodPractice:`Contenha: 1 Headline irresistível, 1 Sub-headline explicativa, 1 ou 2 botões de CTA claros e um elemento visual de suporte.`,commonPitfall:`Poluir a Hero com múltiplos títulos concorrentes, carrosséis automáticos vertiginosos ou textos minúsculos.`,mnemonic:`Hero é a "Capa da Revista": vende o assunto principal e faz você querer abrir as próximas páginas.`,htmlSnippet:`<section class="hero-section">
...
</section>`,cssSnippet:`.hero-section {
  display: flex;
  ...
  background: radial-gradient(circle at top, rgba(99,102,241,0.15), transparent 70%);
      ...
      `}},{id:`header-navbar`,name:`Header & Sticky Navbar (Cabeçalho Global)`,ptName:`Barra Superior Fixa com Navegação e Ações`,category:`structure`,categoryLabel:`Parte que Compõe o Site`,concept:`Faixa superior persistente que abriga a identidade visual da marca, links de navegação principais, busca e perfil/CTA.`,purpose:`Garantir que o usuário nunca se sinta perdido e tenha acesso imediato aos menus principais em qualquer altura da página.`,goodPractice:"Utilize `position: sticky; top: 0; backdrop-filter: blur(12px)` para uma sobreposição suave com o conteúdo rolável.",commonPitfall:`Criar um cabeçalho alto demais que ocupe 25% da tela em dispositivos móveis ou notebooks pequenos.`,mnemonic:`Header é o "Painel do Carro": sempre visível no horizonte com os velocímetros e comandos à mão.`,htmlSnippet:`<header class="sticky-navbar">
...
</header>`,cssSnippet:`.sticky-navbar {
  position: sticky;
  top: 0;
  z-index: 100;
  ...
  border-bottom: 1px solid rgba(255, 255, 255, 0.1);
      ...
      `}},{id:`bento-grid`,name:`Bento Grid (Grade Assimétrica Modular)`,ptName:`Grade Estilo Bento Box Japonesa`,category:`techniques`,categoryLabel:`Técnica de UI/Layout`,concept:`Padrão de layout inspirado em marmitas japonesas (Bento Box), onde cartões com tamanhos e proporções distintas se encaixam harmoniosamente.`,purpose:`Exibir funcionalidades de produtos modernos (popularizado pela Apple, Linear e Stripe) com ritmo visual rico e dinâmico.`,goodPractice:`Destaque o diferencial principal do produto no card maior (que ocupa 2 colunas ou 2 linhas).`,commonPitfall:`Criar assimetrias caóticas sem manter alinhamento das calhas de espaçamento (gap uniforme).`,mnemonic:`Bento Grid é como a "Marmita Japonesa": cada compartimento tem um tamanho certo para o prato correspondente.`,htmlSnippet:`<div class="bento-grid">
...
.bento-col-2 {
  grid-column: span 2;
      ...
      `}},{id:`glassmorphism`,name:`Glassmorphism (Efeito Vidro Fosco)`,ptName:`Translúcido com Desfoque de Fundo`,category:`techniques`,categoryLabel:`Técnica de UI/Layout`,concept:"Estilo visual caracterizado por fundos translúcidos com desfoque (`backdrop-filter`), borda sutil iluminada e sensação de camadas físicas.",purpose:`Criar sensação de profundidade, sofisticação e hierarquia visual em cartões flutuantes, modais e barras de ferramentas.`,goodPractice:"Sempre combine fundo translúcido (`rgba(..., 0.2)`), desfoque (`blur(12px)`) e uma borda fina clara (`border: 1px solid rgba(255,255,255,0.15)`).",commonPitfall:`Ignorar o contraste do texto: se o fundo atrás for claro, o texto branco fica ilegível.`,mnemonic:`Pense em um "Vidro de Box com Vapor de Água": você enxerga as cores borradas do outro lado, mas o foco fica na superfície.`,htmlSnippet:`<div class="glass-card">
  <h3>Cartão Translúcido</h3>
  <p>Texto com alto contraste sobre o desfoque.</p>
</div>`,cssSnippet:`.glass-card {
  ...
  box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.37);
      ...
      `}},{id:`pricing-table`,name:`Pricing Table (Tabela de Preços / Planos)`,ptName:`Matriz Comparativa de Monetização`,category:`structure`,categoryLabel:`Parte que Compõe o Site`,concept:`Módulo estruturado que compara opções de contratação ou assinaturas com valores, lista de benefícios e botão de ação para checkout.`,purpose:`Converter visitantes em clientes pagantes com clareza nos preços e redução de atrito decisório.`,goodPractice:`Destaque o plano recomendado com borda colorida, badge "Mais Popular" ou elevação visual suave.`,commonPitfall:`Esconder custos extras ou limites de uso; a transparência reduz taxas de cancelamento.`,mnemonic:`Pricing Table é o "Cardápio do Restaurante": cada combo tem seus itens inclusos e o valor final destacado.`,htmlSnippet:`<div class="pricing-card is-featured">
...
</div>`,cssSnippet:`.pricing-card.is-featured {
  ...
  transform: scale(1.03);
      ...
      `}},{id:`infinite-marquee`,name:`Infinite Marquee (Letreiro / Faixa Contínua em Loop)`,ptName:`Mural Deslizante Infinito de Logos ou Textos`,category:`techniques`,categoryLabel:`Técnica de UI/Layout`,concept:`Faixa horizontal animada que rola continuamente sem interrupção para expor logos de parceiros, marcas ou depoimentos.`,purpose:`Fornecer autoridade e validação social imediata de forma elegante sem exigir cliques do usuário.`,goodPractice:"Pause a animação ao passar o mouse (`:hover { animation-play-state: paused; }`) para permitir inspeção.",commonPitfall:`Velocidade rápida demais que cause náusea visual ou impeça a identificação dos logos.`,mnemonic:`Pense no "Letreiro de Notícias da Bolsa de Valores": o texto corre continuamente da direita para a esquerda.`,htmlSnippet:`<div class="marquee-wrapper">
...
</div>`,cssSnippet:`@keyframes marquee {
...
.marquee-track {
  ...
  animation: marquee 15s linear infinite;
      ...
      `}},{id:`testimonials-section`,name:`Testimonials & Social Proof (Depoimentos e Prova Social)`,ptName:`Citações de Clientes e Avaliações Reais`,category:`structure`,categoryLabel:`Parte que Compõe o Site`,concept:"Bloco dedicado a depoimentos autênticos, notas de avaliação (`★★★★★`) e cases de sucesso de usuários reais.",purpose:`Romper a desconfiança do visitante através da validação de terceiros (o princípio da Prova Social).`,goodPractice:`Inclua sempre a foto (avatar), nome real, cargo/empresa e um trecho focado no benefício atingido.`,commonPitfall:`Inventar depoimentos genéricos do tipo "Muito bom!" sem foto ou credenciais verificáveis.`,mnemonic:`Testimonial é a "Recomendação do Amigo": tem muito mais peso que a propaganda do próprio vendedor.`,htmlSnippet:`<div class="testimonial-card">
...
</div>`,cssSnippet:`.testimonial-card {
  padding: 1.5rem;
  ...
  border: 1px solid var(--border-subtle);
      ...
      `}},{id:`faq-section`,name:`FAQ Section (Perguntas Frequentes)`,ptName:`Central de Dúvidas com Acordeões Sanfonados`,category:`structure`,categoryLabel:`Parte que Compõe o Site`,concept:`Seção organizada por tópicos colapsáveis que responde às dúvidas e objeções mais comuns do usuário.`,purpose:`Reduzir tickets de suporte ao cliente e acelerar a decisão de compra ou cadastro.`,goodPractice:"Mantenha respostas diretas ao ponto e utilize a tag semântica nativa `<details>` e `<summary>`.",commonPitfall:`Colocar perguntas irrelevantes ou respostas com páginas inteiras de texto.`,mnemonic:`FAQ é a "Seção de Dúvidas Rápidas": mata a charada antes do usuário desistir.`,htmlSnippet:`<section class="faq-section">
  <h2>Perguntas Frequentes</h2>
  <details class="faq-item">
    <summary>O guia é gratuito?</summary>
    <p>Sim, todo o conteúdo é aberto e mantido pela comunidade.</p>
  </details>
</section>`,cssSnippet:`details.faq-item {
...
summary {
  ...
  font-weight: 600;
      ...
      `}},{id:`cta-section`,name:`Call to Action / CTA Banner (Chamada para Ação)`,ptName:`Bloco de Conversão Final`,category:`structure`,categoryLabel:`Parte que Compõe o Site`,concept:`Seção de alto impacto visual posicionada estrategicamente antes do rodapé para induzir o usuário a realizar a ação principal.`,purpose:`Capturar leads, inscrições em newsletters ou encaminhar para download/compra.`,goodPractice:`Foque em apenas 1 ação principal (evite dispersar a atenção com múltiplos formulários no mesmo banner).`,commonPitfall:`Fazer um CTA com frases genéricas como "Clique aqui" em vez de ações orientadas ao benefício (ex: "Começar a Estudar Grátis").`,mnemonic:`CTA é o "Aperto de Mão Final": o momento decisivo de fechar o acordo.`,htmlSnippet:`<section class="cta-banner">
  ...
  border: 1px solid rgba(99,102,241,0.3);
      ...
      `}},{id:`site-footer`,name:`Footer (Rodapé Completo)`,ptName:`Encerramento com Mapa do Site e Links Legais`,category:`structure`,categoryLabel:`Parte que Compõe o Site`,concept:`A última seção da página contendo links secundários, termos legais, mapa do site, canais de contato e copyright.`,purpose:`Oferecer rede de segurança para o usuário que rolou até o fim sem encontrar o que procurava.`,goodPractice:`Organize os links em colunas temáticas (Produto, Recursos, Empresa, Legal).`,commonPitfall:`Esquecer de atualizar o ano do copyright ou deixar links quebrados.`,mnemonic:`Footer é a "Contra-Capa do Livro": ficha catalográfica, índice remissivo e dados da editora.`,htmlSnippet:`<footer class="site-footer">
  ...
  padding: 3rem 1.5rem;
      ...
      `}},{id:`stats-counter`,name:`Stats Counter / KPIs (Métricas em Destaque)`,ptName:`Números Gigantes de Impacto`,category:`techniques`,categoryLabel:`Técnica de UI/Layout`,concept:`Grade de estatísticas numéricas em tipografia grande acompanhada de legendas explicativas para comprovação rápida de autoridade.`,purpose:`Comprovar escala, desempenho ou satisfação (ex: "10k+ usuários", "99.9% uptime", "< 20ms de latência").`,goodPractice:"Utilize fontes legíveis em peso Bold/Extra-Bold e sufixos intuitivos (ex: `k`, `M`, `%`, `+`).",commonPitfall:`Colocar estatísticas vagas que não transmitem valor real ("Mais de 1000 horas trabalhadas").`,mnemonic:`Stats são o "Placar do Jogo": mostram o resultado em números grandes e indiscutíveis.`,htmlSnippet:`<div class="stats-grid">
  <div class="stat-item">
